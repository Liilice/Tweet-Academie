...
<body class="bg-black">
    ...
    <main class="ml-80">
        <div class="flex flex-col w-3/5">
            <form method="GET" id="submit_search" class="flex justify-between items-center text-white text-2xl py-4">
                <input type="search" name="" id="search_hashtag" class="w-full rounded-full bg-gray-800 text-white mr-5" value="#<?=$_GET["hashtag"]?>"/>
